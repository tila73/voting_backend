    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default=django.contrib.auth.hashers.make_password, max_length=128, verbose_name='Password')),
                ('address', models.CharField(max_length=255, null=True, verbose_name='Address')),
                ('phone_number', models.CharField(max_length=255, verbose_name='Phone Number')),
                ('esewa_number', models.CharField(max_length=255, null=True, verbose_name='Esewa Number')),

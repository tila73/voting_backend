...
# update section
    ...
    path('events/update_details/<int:event_detail_id>/',
         views.update_event_detail, name="update_event_detail"),
    path('company/update/<int:company_id>/', views.update_company, name="update_company"),
    path('counts/update/<int:counts_id>/',
         views.update_counts, name="update_counts"),
    path('gallery/update/<int:gallery_id>/',
         views.update_gallery, name="update_gallery"),
    path('slider/update/<int:slider_id>/',
         views.update_slider, name="update_slider"),
#   path('events/update_details/<int:company_id>/', views.update_event_detail, name="update_event_detail"),
    path('faq/update/<int:faaq_id>/', views.update_faq, name="update_faq"),
    path('services/update/<int:service_id>/',
    ...
    path('about/update_details/<int:about_detail_id>/', views.update_about_detail,
         name="update_about_detail"),
    path('blog/update/<int:blogg_id>/', views.update_blog, name="update_blog"),
    path('blog/update_details/<int:blog_detail_id>/', views.update_blog_detail,
         name="update_blog_detail"),
    path('testimonial/update/<int:testimonial_id>/', views.update_testimonial,
         name="update_testimonial"),
    path('testimonial/update_details/<int:testimonial_detail_id>/', views.update_testimonial_detail,
